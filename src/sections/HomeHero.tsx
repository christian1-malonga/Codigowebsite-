    ...
    <div className="hero-inner">
      <div className="hero-copy">
        ...
        <div className="hero-actions">
          <OrangeButton href="/contacts">Request an estimate</OrangeButton>
          <PillLink href="/how-we-work">Explore our process</PillLink>
        </div>
      </div>
      <div className="hero-phone-wrap">
        <img className="hero-phone" src="/phone-mockup-transparent.png" alt="Codigo mobile app preview" />
      </div>
    </div>
  </section>;
}
